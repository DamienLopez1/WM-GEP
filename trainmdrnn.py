...
train_loader = DataLoader(
    RolloutSequenceDataset('D:\steps1000\datasets\mgw', SEQ_LEN, transform, buffer_size=30),
    batch_size=BSIZE, num_workers=0, shuffle=True)
test_loader = DataLoader(
    RolloutSequenceDataset('D:\steps1000\datasets\mgw', SEQ_LEN, transform, train=False, buffer_size=10),
